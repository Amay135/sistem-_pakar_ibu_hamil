...
const Artikel_2 = () => {
    return(
        <div className="container py-5" style={{ maxWidth: "800px" }}>
            ...
            <img src="/images/makanan.jpg" alt="makanan" className="img-fluid rounded mb-4" style={{ width:"100%" }}/>
            <p>
            ...
            <p>
                Menu makanan yang baik untuk ibu hamil perlu diatur dengan mempertimbangkan faktor-faktor kesehatan ibu dan janin itu sendiri. Mari simak informasi tentang rekomendasi makanan sehat untuk ibu hamil yang aman bagi kandungan melalui ulasan berikut.
            </p>
            ...
            <p>
                ...
                Sebelum mengonsumsi buah-buahan, terdapat beberapa hal yang perlu diperhatikan guna menjaga kebersihan buah dan memperoleh manfaatnya secara optimal.  
            </p>
            <p>
            ...
            <p>Sayur merupakan salah satu makanan sehat untuk ibu hamil yang wajib disajikan setiap hari. Penyajian sayur dalam menu makanan pun bisa bervariasi, namun bagi ibu hamil disarankan untuk mengonsumsi sayur yang sudah dimasak hingga matang.
            </p>
            <p>
                Adapun beberapa manfaat dari mengonsumsi sayur bagi ibu hamil adalah:
            </p>
            <ul>
                <li>Mengandung kadar lemak, jumlah kalori, dan kadar kolesterol yang rendah.</li>
                <li>Sayur adalah sumber serat alami yang baik untuk mencegah sembelit saat hamil.</li>
                <li>Sayur mengandung vitamin dan mineral, termasuk asam folat, yang dapat mengurangi risiko cacat tabung saraf, seperti spina bifida pada janin</li>
            </ul>
            <p>
            ...
            <ul>
                ...
                <li>Selai kacang</li>
                <li>Makanan yang terbuat dari kacang kedelai, seperti tahu dan tempe</li>
            </ul>
            ...
            <ul>
                <li>
                    Membantu pembentukan otot dan menguatkan tulang janin.
                </li>
                <li>
                   Mengoptimalkan pertumbuhan jaringan baru pada janin. 
                </li>
                <li>
                    Mendukung perkembangan otak dan saraf janin.
                </li>
                <li>
                    Memperbaiki kerusakan jaringan dan sel-sel selama kehamilan.
                </li>
                <li>
                    Membantu menyalurkan oksigen ke janin.
                </li>
                <li>
                    Mencegah kelahiran prematur dan berat badan lahir rendah.
                </li>
                <li>
                    Mencegah anemia, osteoporosis, hipertensi, dan preeklamsia pada ibu hamil.
                </li>
            </ul>
            ...
            <p>Ibu hamil membutuhkan asupan protein berkualitas tinggi, tidak hanya dari produk nabati, tetapi juga dari produk hewani. Untuk itu, konsumsi daging tanpa lemak sangat dianjurkan selama kehamilan.
            </p>
            <p>
            ...
            <p>
                Penting untuk diingat bahwa menu makanan sehat untuk ibu hamil bisa berbeda bagi setiap ibu. Beberapa makanan mungkin bisa menimbulkan reaksi atau efek samping. Oleh karena itu, penting bagi ibu hamil untuk mendapatkan rekomendasi makanan yang sehat dengan mendatangi Dokter Spesialis Gizi Klinik di Siloam Hospitals terdekat.
            </p>
            ...
            <a href="https://www.siloamhospitals.com/informasi-siloam/artikel/makanan-sehat-untuk-ibu-hamil">
            Sumber lainnya
            </a>
